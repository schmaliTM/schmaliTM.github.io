<template>
	<svg
		...
		viewBox="0 0 55.1 53.5"
		height="55px"
		class="dark:fill-gruen fill-grau"
	>
		<g>
			<path
				d="M23.2,28.1c-1.5,0-2.9-0.1-4.1-0.4c-1.3-0.3-2.4-0.7-3.4-1.2l-0.3-5.8h4.1l0.7,2.8c0.3,0.1,0.5,0.3,0.9,0.4
			...
			<path
				d="M39.6,10.5v-8h-7.4v2.7l2.2,0.4V6v16.3c0,0,0.2,13.5,0.9,17.3c0.6-0.2,1.1-0.3,1.6-0.4l0,0l0,0
					c0.7,0,1.3,0.1,1.8,0.3c0.6-3.8,1-17.5,1-17.5v-2.2v-7L39.6,10.5z"
			/>

			<path
				d="M37.8,40.2c-0.3,0-3.9-0.4-5,2.8c-0.3,0.8-0.3,1.8-0.3,2.8c-0.1,2.3-0.2,5-3,7.7c2.7-0.3,7-1.3,9.7-4.2
					c1.6-1.6,2.2-3.7,2.2-6.2C41.2,43.1,41,40.9,37.8,40.2z"
			/>

			<path
				d="M8.8,33.1c-2.2-0.6-3.8-1.6-4.7-3s-1.4-3-1.4-4.9v-3.4c0-1-0.2-1.8-0.7-2.4c-0.4-0.6-1.1-0.8-2-0.8v-4
			...
			/>
			<path
				d="M46.3,33.1L45.2,30c0.8-0.3,1.3-0.9,1.6-1.7c0.3-0.8,0.5-1.9,0.5-3.1v-3.4c0-1.2,0.3-2.2,0.8-3.1
